...
int main(void)
{
  ...
  LCD_GPIO rs_pin = {.GPIO_PORT = GPIOB, .pin = GPIO_PIN_12};
  LCD_GPIO en_pin = {.GPIO_PORT = GPIOB, .pin = GPIO_PIN_13};
  LCD_GPIO D4_pin = {.GPIO_PORT = GPIOB, .pin = GPIO_PIN_3};
  LCD_GPIO D5_pin = {.GPIO_PORT = GPIOB, .pin = GPIO_PIN_4};
  LCD_GPIO D6_pin = {.GPIO_PORT = GPIOB, .pin = GPIO_PIN_5};
  LCD_GPIO D7_pin = {.GPIO_PORT = GPIOB, .pin = GPIO_PIN_6};
  ...
  lcd_init(&theLCD);
  lcd_cursor_on(&theLCD);
  lcd_blink_on(&theLCD);

  lcd_print(&theLCD, "Hello");
  /* USER CODE END 2 */
